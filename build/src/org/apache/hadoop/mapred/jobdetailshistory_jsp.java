 ...
 static SimpleDateFormat dateFormat = new SimpleDateFormat("d-MMM-yyyy HH:mm:ss") ; 
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (job == null) {
      ...
      out.print(jobid );
      out.write(" on <a href=\"jobhistoryhome.jsp\">History Viewer</a></h2>\n\n<b>User: </b> ");
      out.print(HtmlQuoting.quoteHtmlChars(job.get(Keys.USER)) );
      out.write("<br/> \n<b>JobName: </b> ");
      out.print(HtmlQuoting.quoteHtmlChars(job.get(Keys.JOBNAME)) );
  ...
  JSPUtil.printJobACLs(jobConf, jobAcls, out);
      ...
      out.write("<br/> \n<b>Failure Info: </b> ");
      out.print( ((job.get(Keys.FAIL_REASON) == null)?"NA" : job.get(Keys.FAIL_REASON)) );
      out.write("<br/>\n");
